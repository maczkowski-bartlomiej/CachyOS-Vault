...
|---|---|---|---|---|---|
| I3 | `custom-configs/I3/config` | `~/.config/i3/config` | `~/.config/custom-themes/i3-theme.i3` | `include ~/.config/custom-themes/i3-theme.i3` | Also installs `custom-themes/wallpaper/wallpaper.jpg` to `~/.config/i3/wallpaper.jpg`; installer reloads i3 when available and not skipped. |
