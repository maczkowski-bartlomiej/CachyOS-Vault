...
Builder: custom-configs/Themes/builders/theme-build-betterlockscreen
```
...
Use the Betterlockscreen cache tweak when the lockscreen wallpaper cache needs refreshing:
